 ...
 * action nulls it server-side and this gate reappears on its own.
 */
export function OnboardingGate() {
  ...
  const finish = async () => {
    try {
      ...
      // Server unreachable — don't trap the user behind the walkthrough; let them in and it will
      // simply reappear next load if the patch never landed.
