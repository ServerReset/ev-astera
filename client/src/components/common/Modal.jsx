    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      <div
        ...
        className={cn(
          ...
          'rounded-t-xl-increased sm:rounded-xl-increased animate-slide-up',
      ...
      >
        <div className="flex items-center justify-between gap-3 border-b border-border px-5 py-3.5 sticky top-0 bg-surface/80 backdrop-blur-sm z-10">
          <h2 className="text-title-md text-content">{title}</h2>
          <button
            onClick={onClose}
            className="grid h-9 w-9 place-items-center rounded-full text-muted transition-[background-color,color] duration-short hover:bg-surface-2 hover:text-content active:scale-90"
            aria-label="Close"
          >
            <X className="h-5 w-5" />
          </button>
